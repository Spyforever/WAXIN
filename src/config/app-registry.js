...
export const appRegistry = {
  ...
  defrag: {
    config: {
      ...
      icon: ICONS.defrag,
      category: "Accessories/System Tools",
      width: 400,
      height: 300,
      resizable: true,
      isSingleton: true,
  ...
  "flash-player": {
    config: {
      ...
      category: "Accessories/Entertainment",
      width: 550,
      height: 400,
      resizable: true,
    },
  ...
  "sound-scheme-explorer": {
    ...
    importApp: () =>
      import("../apps/sound-scheme-explorer/sound-scheme-explorer-app.js"),
  },
  "spider-solitaire": {
    config: {
      id: "spider-solitaire",
  ...
  "display-properties": {
    ...
    importApp: () =>
      import("../shell/display-properties/display-properties-app.js"),
  },
};
