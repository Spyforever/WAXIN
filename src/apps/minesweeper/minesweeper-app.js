...
export class MinesweeperApp extends Application {
  ...
  resetGame() {
    ...
    if (this.boardEl) {
      ...
      this.smileyEl.css(
        "backgroundImage",
        `url(${new URL("./assets/minesweeper-smiley-neutral.png", import.meta.url).href})`,
      );
    }
  }
  ...
  handleMouseDown(e) {
    ...
    if (!cell.isRevealed && !cell.isFlagged) {
      ...
      this.smileyEl.css(
        "backgroundImage",
        `url(${new URL("./assets/minesweeper-smiley-click.png", import.meta.url).href})`,
      );
  ...
  _revealCellAndUpdateGameState(cellEl) {
    ...
    if (result === "mine") {
      ...
      this.smileyEl.css(
        "backgroundImage",
        `url(${new URL("./assets/minesweeper-smiley-lose.png", import.meta.url).href})`,
      );
      this.renderBoard();
    } else if (result === "win") {
      this.game.isGameOver = true;
      ...
      this.smileyEl.css(
        "backgroundImage",
        `url(${new URL("./assets/minesweeper-smiley-win.png", import.meta.url).href})`,
      );
      if (
